...
export const troubleshootCommonIssues: TroubleshootSection[] = [
  ...
  },
  {
    ...
    steps: [
      'macOS: System Settings → Network → Firewall — allow DmonWork.',
      'Windows: Defender Firewall → Allow app — enable DmonWork for Private networks.',
  ...
  },
  {
    ...
    steps: [
      'DmonWork must be open on your desktop to accept connections.',
      'Try restarting DmonWork — the companion server starts on launch.',
