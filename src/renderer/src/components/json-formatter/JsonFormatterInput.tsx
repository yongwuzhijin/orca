  ...
  return (
    <Editor
      ...
      options={{
        ...
        readOnly,
        // Why: readOnly alone still focuses Monaco's hidden textarea, which swallows the
        // drawer's own key handling; domReadOnly keeps the viewer out of the typing path.
