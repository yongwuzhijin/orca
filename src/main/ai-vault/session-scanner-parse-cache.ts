...
function resumableStateFactoryFor(
  ...
  switch (candidate.agent) {
    case 'claude':
      return (messages) => createClaudeSessionResumeState(candidate.file, 'claude', messages)
    case 'qoder':
      return (messages) => createClaudeSessionResumeState(candidate.file, 'qoder', messages)
    case 'codex':
      return (messages) =>
