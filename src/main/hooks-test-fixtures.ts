...
export const TEST_ORCA_DIR_NAME = '.orca'
export const TEST_CUSTOM_ORCA_DIR_NAME = '.tmp/orca'
export const TEST_ISSUE_COMMAND_PATH = join(TEST_REPO_PATH, '.orca', 'issue-command')
export const TEST_CUSTOM_ISSUE_COMMAND_PATH = join(TEST_REPO_PATH, '.tmp', 'orca', 'issue-command')
