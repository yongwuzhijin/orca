...
is_owned_link() {
  ...
  for candidate in /opt/DmonWork/resources/bin/orca-ide /opt/Orca/resources/bin/orca-ide /opt/orca-ide/resources/bin/orca-ide /opt/orca/resources/bin/orca-ide; do
